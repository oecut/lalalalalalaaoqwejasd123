...
public class SharedConfig {
    ...
    public static void toggleCyberSecAnonymousMode() {
        cyberSecAnonymousMode = !cyberSecAnonymousMode;
        ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", Activity.MODE_PRIVATE)
                .edit()
                .putBoolean("cyberSecAnonymousMode", cyberSecAnonymousMode)
                .apply();
    }
    
    public static void toggleCyberSecHideIP() {
        cyberSecHideIP = !cyberSecHideIP;
        ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", Activity.MODE_PRIVATE)
                .edit()
                .putBoolean("cyberSecHideIP", cyberSecHideIP)
                .apply();
    }
    
    public static void toggleCyberSecEncrypt() {
        cyberSecEncrypt = !cyberSecEncrypt;
        ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", Activity.MODE_PRIVATE)
                .edit()
                .putBoolean("cyberSecEncrypt", cyberSecEncrypt)
                .apply();
    }
    
    public static void toggleCyberSecAntiTracking() {
        cyberSecAntiTracking = !cyberSecAntiTracking;
        ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", Activity.MODE_PRIVATE)
                .edit()
                .putBoolean("cyberSecAntiTracking", cyberSecAntiTracking)
                .apply();
    }
    
    public static void toggleCyberSecSecureDNS() {
        cyberSecSecureDNS = !cyberSecSecureDNS;
        ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", Activity.MODE_PRIVATE)
                .edit()
                .putBoolean("cyberSecSecureDNS", cyberSecSecureDNS)
                .apply();
    }
    ...
    public static boolean cyberSecAnonymousMode = false;
    public static boolean cyberSecHideIP = false;
    public static boolean cyberSecEncrypt = false;
    public static boolean cyberSecAntiTracking = false;
    public static boolean cyberSecSecureDNS = false;
...
//    public static int saveToGalleryFlags;
    ...
    public static void loadConfig() {
        synchronized (sync) {
            ...
            cyberSecAnonymousMode = preferences.getBoolean("cyberSecAnonymousMode", false);
            cyberSecHideIP = preferences.getBoolean("cyberSecHideIP", false);
            cyberSecEncrypt = preferences.getBoolean("cyberSecEncrypt", false);
            cyberSecAntiTracking = preferences.getBoolean("cyberSecAntiTracking", false);
            cyberSecSecureDNS = preferences.getBoolean("cyberSecSecureDNS", false);
