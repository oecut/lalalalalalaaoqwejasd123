...
def get_admin_menu() -> InlineKeyboardMarkup:
    ...
    builder.button(text="📈 Аналитика", callback_data="admin_global_stats")
    builder.button(text="👥 Список групп", callback_data="admin_group_list")
    builder.button(text=Buttons.back, callback_data="back_to_main")
...
def get_demo_mode_menu(triggers: List[Tuple[int, int, str, bool]]) -> InlineKeyboardMarkup:
    ...
    builder = InlineKeyboardBuilder()
    builder.button(text="✨ Создать анимированный триггер", callback_data="admin_demo_add")
    if triggers:
        builder.button(text="🗑️ Удалить триггер", callback_data="admin_demo_delete_list")
